<section class="container">
	<?php if ( !  is_checkout() && !  is_page( 19 ) && !  is_cart() ): ?>
	<div id="footer-signup" class="clx">
		<div>
			<p><?php _e( 'Get the latest on ats diamond tools right into your inbox', 'TEXT_DOMAIN' )?></p>
		</div>
	...
	<div class="copyright">
		<div class="container">
			<div class="susy-reset">
				...
				<div class="right">
					<p><a href="https://www.redfrogstudio.co.uk" target="_blank"><?php esc_html_e( 'Website by Red Frog', 'TEXT_DOMAIN' )?></a></p>
				</div>
			</div>
		</div>
	</div>
