...
function sv_require_second_street_address_field($fields) {
    $fields['address_1']['label'] = esc_attr__('House/flat name or number, Street name', 'woocommerce');
    $fields['address_1']['placeholder'] = esc_attr__('House/flat name or number, Street name', 'woocommerce');
