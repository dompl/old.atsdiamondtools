...
function img_figure( $image_id = null, $width = 150, $height = 100, $crop = false, $upscale = true, $retina = false )
{
    ...
    $image     = wpimage( 'img=' . $image_id . '&w=' . $width . '&h=' . $height . '&crop=' . $crop . '&retina=' . $retina . '&upscale=' . $upscale );
    $image_alt = get_post_meta( $image_id, '_wp_attachment_image_alt', true );
    $figure    = '<figure><img src="' . $image . '" width="' . $width . 'px" alt="' . $image_alt . '" class="lazy" /></figure>';
    $figure .= '<noscript><img src="' . $image . '" alt="' . $image_alt . '" /></noscript>';
