...
function page_header_( $thumnail_id )
{
    ...
    if ( is_product_category() ) {
        ...
        if ( $thumnail_id ) {
            ...
            $page_image        = wpimage( 'img=' . $thumnail_id . '&w=' . $image_widht . '&h=' . $image_height . '&crop=false&retina=false&upscale=true' );
            $page_image_retina = wpimage( 'img=' . $thumnail_id . '&w=' . ( $image_widht * 2 ) . '&h=' . ( $image_height * 2 ) . '&crop=false&retina=false&upscale=true' );
        }
        // Description
        ob_start();
