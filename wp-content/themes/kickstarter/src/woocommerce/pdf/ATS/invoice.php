    ...
    <tbody>
        ...
        <tr class="<?php echo apply_filters( 'wpo_wcpdf_item_row_class', $item_id, $this->type, $this->order, $item_id ); ?>">
            <td class="product">
                ...
                <dl class="meta" style="margin-top:-5px; padding-top:0">
                    <?php if (  !  empty( $item['sku'] ) ): ?>
                    <div style="margin-top:0">
                        <dt style="margin-right: 5px; font-size:9px"><span style="font-size:9px; font-weight:bold"><?php _e( 'SKU:', 'woocommerce-pdf-invoices-packing-slips' );?></span> <span style="font-size:9px;"><?php echo $item['sku']; ?></span></dt>
                    </div>
                    <?php endif;?>
