...
if ($terms_page_id > 0 && apply_filters('woocommerce_checkout_show_terms', true)):
    ...
    <p class="form-row terms wc-terms-and-conditions">
      <label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox">
        <input type="checkbox" class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox" name="terms" <?php checked(apply_filters('woocommerce_terms_is_checked_default', isset($_POST['terms'])), true);?> id="terms" /> <span><?php printf(__('I&rsquo;ve read and accept the <a href="%s" target="_blank" class="woocommerce-terms-and-conditions-link">terms &amp; conditions</a> ', 'woocommerce'), esc_url(wc_get_page_permalink('terms')));?> and <?php echo '<a href="' . esc_url(get_permalink(62)) . '" title="Privacy Statement & Cookie Notice" target="_blank">privacy statement</a>' ?></span> <span class="required">*</span>
      </label>
