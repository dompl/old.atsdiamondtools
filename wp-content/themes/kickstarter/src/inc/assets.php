...
function voidx_assets_header()
{
    ...
    wp_register_style( 'style', get_stylesheet_uri(), $dependencies = array(), get_template_directory() . '/style.css' );
...
function voidx_assets_footer()
{
    ...
    wp_enqueue_script( $name, get_stylesheet_directory_uri() . '/js/' . $file . '.js', array( 'jquery' ), get_template_directory() . '/js/' . $file . '.js', true ); // This last `true` is what loads the script in the footer
