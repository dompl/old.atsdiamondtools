# A WORDPRESS/GULP STARTER KIT - This is now premature and theme has far more feaures.
...
* Edit `gulpconfig.js` and, *at the very least*, change the `theme` variable to match the name of your theme. If you like the way this workflow is setup you shouldn't need to edit any of the files under `gulpfile.js/tasks` just yet.
