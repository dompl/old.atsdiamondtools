...
class YITH_YWEV_Report_EU_VAT_Taxes extends WC_Admin_Report {
	...
	public function get_export_button() {
		...
		<a href="#"
		   ...
		   class="export_csv"
		   data-export="table"><?php _e ( 'Export CSV', 'yith-woocommerce-eu-vat' ); ?></a>
		<?php
	}
	...
	public function get_main_chart() {
		...
		foreach ( $eu_vat_orders as $eu_vat_order ) {
            ...
            $eu_vat_amount = $order_metas['eu_vat_amount'];
			...
			$taxes_by_countries[ $country ] += $temp_sum > 0 ? $temp_sum : $eu_vat_amount;
		}
		...
		<table class="widefat">
			...
			<?php else : ?>
				<tbody>
				<tr>
					<td><?php _e ( 'No taxes payments found in this period', 'yith-woocommerce-eu-vat' ); ?></td>
				</tr>
				</tbody>
			<?php endif; ?>
		</table>
