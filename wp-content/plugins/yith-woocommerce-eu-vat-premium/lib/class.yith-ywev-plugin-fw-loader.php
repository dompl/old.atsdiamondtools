...
if ( ! class_exists( 'YITH_YWEV_Plugin_FW_Loader' ) ) {
	...
	class YITH_YWEV_Plugin_FW_Loader {
		...
		public function register_panel() {
			...
			$admin_tabs['reports']     = __( 'Reports', 'yith-woocommerce-eu-vat' );
		...
		public function register_pointer() {
			...
			$args[] = array(
				...
				'content'    => sprintf( '<h3>YITH WooCommerce EU VAT</h3> <p> %s </p>',
					__( 'In the YITH tab, you can find the YITH WooCommerce EU VAT options.<br> From this menu you can have access to all settings of the activated YITH plugins.', 'yith-woocommerce-eu-vat' ) . '<br>' . $premium_message
				),
		...
		public function register_plugin_for_activation() {
			if ( ! class_exists( 'YIT_Plugin_Licence' ) ) {
				require_once YITH_YWEV_DIR . '/plugin-fw/licence/lib/yit-licence.php';
				require_once YITH_YWEV_DIR . '/plugin-fw/licence/lib/yit-plugin-licence.php';
			}
