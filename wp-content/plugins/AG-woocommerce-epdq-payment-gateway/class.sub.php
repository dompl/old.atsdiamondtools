<?php
    ...
    /**
     * @extends epdq_checkout
     * Adds subscriptions support.
     */
    class epdq_sub extends epdq_checkout {
        ...
        public function __construct() {
            ...
            if ( class_exists( 'WC_Subscriptions_Order' ) ) {
                ...
                if ( class_exists( 'WC_Payment_Token_CC' ) ) {
                    ...
                    add_action( 'woocommerce_subscriptions_changed_failing_payment_method_epdq', array( $this, 'update_failing_payment_method' ), 10, 3 );
                }
        ...
        function woocommerce_process_scheduled_subscription_payment( $amount_to_charge, $order ) {
            ...
            // Check for token
            $epdqtoken = get_post_meta( $parent_order_id, '_SagePayDirectToken', true );

            if( $epdqtoken && $epdqtoken != '' ) {
