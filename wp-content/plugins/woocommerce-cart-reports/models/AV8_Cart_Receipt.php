...
class AV8_Cart_Receipt
{
    ...
    public function insert_receipt()
    {
	    ...
	    update_post_meta($this->post_id, 'av8_cart_created_date', date('Y-m-d H:i:s')); //Save created time
        update_post_meta($this->post_id, 'av8_last_updated', time()); //Initialize the updated time
	    update_post_meta($this->post_id, 'av8_last_updated_date', date('Y-m-d H:i:s')); //Save created time
    }
