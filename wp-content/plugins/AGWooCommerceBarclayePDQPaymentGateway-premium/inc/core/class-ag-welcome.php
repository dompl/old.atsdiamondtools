...
class AG_welcome_screen {
	...
	public function ag_welcome_screen() {
		...
		$hook_suffix = add_menu_page( 'Welcome to AG', 'AG Plugins', 'manage_options', htmlspecialchars( self::$args['parent_slug'] ), array( $this, 'setup_welcome_page' ), 'dashicons-admin-network' );
        ...
        <div class="wrap ag-welcome-wrap">
            ...
            <div class="ag-welcome-body">
                ...
                <div class="section">
                    ...
                    <a class="product-card" target="_blank" href="https://feedback.weareag.co.uk/feature-request?utm_source=<?php echo self::$args['main_slug']; ?>&amp;utm_medium=insideplugin" style="width: 378.667px; float: left; margin-right: 32px">
                        <div class="product-card-content">
                            <div class="product-card-main">
