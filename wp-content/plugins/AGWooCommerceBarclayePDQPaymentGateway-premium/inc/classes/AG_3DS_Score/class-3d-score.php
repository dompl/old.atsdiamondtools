...
class ePDQ_3D_score
{
    ...
    public static function AG_3D_score_colours($data){
        ...
        $colour_rating = array('#40F99B' => 'Low Risk', '#FD5A40' => 'Medium Risk', '#FE1A3B' => 'High Risk', '#40F99B' => 'Perfect');
    ...
    public static function AG_IP_check($order){
        ...
        if($location['country'] != $billing) {
            return array('data' => 'This customers IP address did not match the given billing country', 'score' => $score);
        }
