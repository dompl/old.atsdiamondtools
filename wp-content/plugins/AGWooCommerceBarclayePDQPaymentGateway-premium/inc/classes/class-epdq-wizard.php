...
class AG_ePDQ_Wizard_steps
{
    ...
    public static function wizard_step_four() { 
		...
		<form method="post" class="step">
            ...
            <p class="setup-text">
            <?php echo __('The first item is setting the payment page URL, this is the domain before the customer is sent to the ePDQ servers to make the payment, It normally looks like the following:', 'ag_epdq_server'); ?> <strong><?php echo site_url(); ?></strong>
            </p>
            ...
            <a href="#img6">
                <img src="https://d33v4339jhl8k0.cloudfront.net/docs/assets/5bc91552042863158cc79df7/images/5f6dce13cff47e00168fa561/file-wkhS8JsD0D.png" class="thumbnail" />
            </a>
