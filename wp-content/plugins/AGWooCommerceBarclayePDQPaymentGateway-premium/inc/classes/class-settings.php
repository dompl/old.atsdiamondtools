        ...
        public static function form_fields()
        {
                ...
                return array(
                        ...
                        'description' => array(
                                ...
                                'type' => 'textarea',
                                'description' => __('Description of the payment process. This description will be visible throughout the site and the payment page.', 'ag_epdq_checkout'),
                        ...
                        'access_key' => array(
                                ...
                                'type' => 'text',
                                'description' => __('The PSPID for your barclays account. This is the id which you use to login the admin panel of the barclays bank. <small><strong>Remember you must test using the test ePDQ account Barclays supply you</strong></small>', 'ag_epdq_checkout'),
                                'default' => '',
                                //'desc_tip'      => true
                        ),
                        'status' => array(
                    ...
                    Please bear in mind that using a dynamic template page involves an additional request from our system to look up your template page. This increases the time needed for the payment process.', 'ag_epdq_checkout'),
                        ...
                        'pmlisttype'        => array(
                                'title'                 => __('Layout of the payment methods', 'ag_epdq_checkout'),
                                'type'                         => 'select',
                                'class'                        => 'chosen_select',
                                'css'                 => 'width: 350px;',
                                'description'         => __('You can arrange the layout/list of the payment methods on Barclays payment page', 'ag_epdq_checkout'),
                                'default'                 => '0',
                                'options'                 => array(
                                        '0'      => __('Horizontally grouped logos with the group name on the left (default value)', 'ag_epdq_checkout'),
                                        '1'      => __('Horizontally grouped logos with no group names', 'ag_epdq_checkout'),
                                        '2'      => __('Vertical list of logos with specific payment method or brand name', 'ag_epdq_checkout'),
                                ),
                        ),
                        'cardtypes'        => array(
                                ...
                                'options'                 => array(
                                        ...
                                        'diners'                                => __('Diners', 'ag_epdq_checkout'),
